...
?>
 ...
 <div class="row">
  <div class="col-lg-6 text-center ">
    <img src="../images/do-item.jpg" alt="pic" style="width:540px;height:360px;margin-top:90px;">
  </div>
  ...
  <form method="post" class="form-signin">
    <h4 class="amt-img">Enter your Items</h4>
<hr>
     <div class="form-group">
      <input type="text" class="form-control" name="item" placeholder="Item" size="25" />
    </div>
